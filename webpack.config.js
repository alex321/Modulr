...
module.exports = function makeWebpackConfig() {
  ...
  if (isTest && !isTestWatch) {
    // awesome-typescript-loader needs to output inlineSourceMap for code
    // coverage to work with source maps.
  ...
  if (!isTest && !isTestWatch) {
    config.plugins.push(
        ...
        new ExtractTextPlugin(
            {filename: 'css/[name].[hash].css', disable: !isProd}));
  }
  ...
  config.devServer = {
    ...
    quiet: true,
    stats: 'minimal'  // none (or false), errors-only, minimal, normal (or true)
                      // and verbose
  };
